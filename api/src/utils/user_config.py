...
from src.service.manager import get_user_manager
...
current_user = fastapi_users.current_user(superuser=True)
current_user_not_superuser = fastapi_users.current_user()