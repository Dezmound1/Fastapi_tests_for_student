...
Revision ID: d57ce785b7ed
Revises: 
Create Date: 2024-05-11 01:37:01.227926
...
def upgrade() -> None:
    ...
    op.create_table('tests_tudent',
    sa.Column('test_student_id', sa.Integer(), nullable=False),
    sa.Column('test_id', sa.Integer(), nullable=False),
    sa.Column('student_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.ForeignKeyConstraint(['test_id'], ['test.id'], ),
    sa.PrimaryKeyConstraint('test_student_id')
    )
